...
elseif (EXISTS "/usr/local/include/seccomp.h")
    ...
    set(REQ_URL "${CANN_3RD_LIB_PATH}/libseccomp-2.5.4/libseccomp-2.5.4.tar.gz")
    if(EXISTS ${REQ_URL})
        message(STATUS "[UDF seccomp] ${REQ_URL} found in local")
    elseif(EXISTS "${CANN_3RD_LIB_PATH}/libseccomp-2.5.4")
        message(STATUS "[UDF seccomp] ${CANN_3RD_LIB_PATH}/libseccomp-2.5.4 found in local")
