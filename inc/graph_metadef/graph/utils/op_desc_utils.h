...
class OpDescUtils {
 public:
  ...
  static ge::graphStatus GetInputIrIndexByInstanceIndex(const OpDescPtr &op_desc, size_t instance_index,
                                                        size_t &ir_index);
  static ge::graphStatus GetOutputIrIndexByInstanceIndex(const OpDescPtr &op_desc, size_t instance_index,
                                                         size_t &ir_index);
