...
aclError aclopSetAttrListDataTypeImpl(aclopAttr *attr, const char *attrName, int numValues,
...
aclError aclopSetAttrListListIntImpl(aclopAttr *attr, const char *attrName, int numLists, const int *numValues,
