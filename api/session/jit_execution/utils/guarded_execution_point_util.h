...
class GuardedExecutionPointUtil {
 public:
  ...
  Status AddGuardedExecutionPointGraphKey(std::string root_dir, std::string user_graph_key,
                                          const GuardedExecutionPoint *gep);

  Status EmplaceGuardedExecutionPointOption(std::string root_dir, std::string user_graph_key,
                                            const GuardedExecutionPoint *gep,
