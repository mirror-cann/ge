...
class ShapeTransferAccordingToFormat {
 public:
  ...
  /* deprecated ATTRIBUTED_DEPRECATED(static bool TransferShape(const ge::Format &, const ge::Format &, const
     ge::DataType &, gert::Shape &, const ExtAxisOpValue &, const fe::PlatFormInfos *)) */
  static bool TransferShape(const ge::Format &origin_format, const ge::Format &format, const ge::DataType &data_type,
  ...
  /* deprecated ATTRIBUTED_DEPRECATED(static bool TransferShape(const ge::Format &, const ge::Format &, const
     ge::DataType &, const gert::Shape &, gert::Shape &, const ExtAxisOpValue &)) */
  static bool TransferShape(const ge::Format &origin_format, const ge::Format &format, const ge::DataType &data_type,
