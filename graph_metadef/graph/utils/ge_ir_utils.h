...
class OnnxUtils {
 ...
 private:
  ...
  static void AddAttrProtoForAttrsFromAttrMap(const ::google::protobuf::Map<std::string, ge::proto::AttrDef> &attr_map,
                                              ge::onnx::NodeProto *const node_proto, const std::string &prefix = "",
  ...
  static bool DecodeGraph(const int32_t recursion_depth, const ge::onnx::GraphProto &graph_proto,
                          ComputeGraphPtr &graph);

  static void AddShapeFormatAndDtypeToJson(const ge::ConstGeTensorDescPtr &desc, nlohmann::json &tensor_json);

  static void AddShapeFormatAndDtypeToProto(const ge::ConstGeTensorDescPtr &desc, const std::string &prefix,
