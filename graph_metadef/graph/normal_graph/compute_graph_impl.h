...
class ComputeGraphImpl {
 ...
 private:
  ...
  ge::NodePtr CreateNodeFromOpDesc(const OpDescPtr &op_desc, const ComputeGraphPtr &compute_graph,
 ...
 private:
  ...
  graphStatus UpdateNetOutput(const ComputeGraphPtr &compute_graph, const ge::NodePtr &output_node,
                              bool update_data_edge);
  graphStatus UpdateNetOutputDesc(const ge::NodePtr &net_output) const;
  graphStatus UpdateNetOutputParentNodeIndex(const ge::NodePtr &net_output,
