...
class BufQueAllocator {
 ...
 private:
  ...
  Status ProcessSingleImplGraph(ge::AscGraph &impl_graph, BasePlatform &platform, size_t max_que_num,
  ...
  static Status TopoSortByCubeLoadPriority(ge::AscGraph &graph);
