...
class HcomOpUtils {
 public:
  ...
  static HcclResult CalcCountForAlignedOp(const ge::OpDescPtr &op, const std::string &sCollectiveType, u32 dataTypeSize,
                                          u64 &count);
  static HcclResult CalcCommonCount(const ge::OpDescPtr &op, const std::string &sCollectiveType, u32 dataTypeSize,
