...
class AicpuKernelBuilder : public CpuKernelBuilder {
 ...
 private:
  ...
  // Copy prohibited
  AicpuKernelBuilder &operator=(const AicpuKernelBuilder &aicpu_kernel_builder) = delete;

  // Move prohibited
  AicpuKernelBuilder &operator=(AicpuKernelBuilder &&aicpu_kernel_builder) = delete;
