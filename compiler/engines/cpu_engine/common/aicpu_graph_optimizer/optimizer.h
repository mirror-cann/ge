...
class Optimizer {
 public:
   ...
   * @return status whether this operation success
   */
  virtual ge::Status OptimizeOriginalGraphJudgeInsert(const ge::ComputeGraph &graph,
   ...
   * @return status whether this operation success
   */
  virtual ge::Status OptimizeFusedGraph([[maybe_unused]] ge::ComputeGraph &graph,
                                        [[maybe_unused]] const std::map<std::string, OpFullInfo> &all_op_info) const {
    return ge::SUCCESS;
  }
 ...
 protected:
   ...
   * @return status whether this operation success
   */
  ge::Status GetFrameworkOpType(const ge::OpDescPtr &op_desc_ptr, std::string &op_type) const;
 ...
 private:
   ...
   * @return status whether this operation success
   */
  ge::Status UpdateInputFormatAndShape(const OpFullInfo &op_info, const ge::OpDescPtr &op_desc_ptr) const;
   ...
   * @return status whether this operation success
   */
  ge::Status UpdateOutputFormatAndShape(const OpFullInfo &op_info, const ge::OpDescPtr &op_desc_ptr) const;
   ...
   * @param format Format
   */
  void GetFormat(const std::map<std::string, std::string> &formats, const std::string &format_name,
                 ge::Format &format) const;
   ...
   */
  void UpdateTensorDesc(ge::GeTensorDesc &tensor_desc, const ge::Format &src_format,
...
#define FACTORY_GRAPH_OPTIMIZER_CLASS_KEY(CLASS, KEY) FACTORY_GRAPH_OPTIMIZER::Register<CLASS> __##CLASS(KEY);
}  // namespace aicpu
