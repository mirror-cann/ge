...
class GraphLoader {
 public:
  ...
  static Status LoadModelOnline(uint32_t &model_id, const GeRootModelPtr &ge_root_model, const GraphNodePtr &graph_node,
                                const uint32_t device_id, const error_message::ErrorManagerContext &error_context,
