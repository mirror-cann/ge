...
Status SwapMergeCastFusionTestPass::AddCastNodeBeforeMergeNode(const ge::NodePtr &merge_node,
...
Status SwapMergeCastFusionTestPass::VerifyNodes(const ge::NodePtr &merge_node, ge::NodePtr &cast_node,
