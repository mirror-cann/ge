...
class STEST_concat_optimize_checker : public testing::Test {
 ...
 protected:
  ...
  void InitGraph5QuantNotAligned(ComputeGraphPtr &graph) {
     ...
     *          |
     */
    ge::GraphUtils::AddEdge(quant1_node->GetOutDataAnchor(0), concat_node->GetInDataAnchor(0));
    ge::GraphUtils::AddEdge(quant2_node->GetOutDataAnchor(0), concat_node->GetInDataAnchor(1));
  }
};
