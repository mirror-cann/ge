...
void CompareGeneralizeShape(pair<vector<int64_t>, vector<int64_t>> &shapeGeneralize, ge::GeTensorDescPtr &tenosrDescPtr)
{
    ...
    EXPECT_EQ(res, true);
    res = (shapeGeneralize.second.size() == oriShape.size() || (shapeGeneralize.second.size() == 1 && oriShape.size() == 0)) ? true : false;
    EXPECT_EQ(res, true);
...
TEST(FuzzyBuildSTest, TaskFirstCompileSuccess) {
    ...
    opRes->jsonFilePath = te::fusion::RealPath(currentFilePath + "/kernel_meta/te_matmul_2ac1b9067af400eb161d75ccd6c6ca71bed7b97750d79c4476fb65ac9bedd762.json");
...
TEST(FuzzyBuildSTest, fusion_util_DirPath) {
    ...
    res = DirPath("");
    EXPECT_EQ(res, "");
...
TEST(FuzzyBuildSTest, fusion_serial_ParseResult) {
    ...
    te::fusion::PythonAdapterManager::ParseResult(opResPreCompile.c_str(), 0, jsonFilePath, pattern, coreType, compileInfo, compileInfoKey, fusionCheckRes);
    ...
    te::fusion::PythonAdapterManager::ParseResult(opResPreCompile_bad.c_str(), 0, jsonFilePath, pattern, coreType, compileInfo, compileInfoKey, fusionCheckRes);
