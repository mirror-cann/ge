...
namespace te {
namespace fusion {
class TeConfigInfoUT : public testing::Test {
 protected:
  static void SetUpTestSuite() {
    std::cout << "TeConfigInfoUT SetUpTestSuite" << std::endl;
  }

  static void TearDownTestSuite() {
    std::cout << "TeConfigInfoUT TearDownTestSuite" << std::endl;
  }
};

TEST(TeConfigInfoUT, init_lib_path) {
...
// TEST(TeConfigInfoUT, init_env_param)
// {
//     TeConfigInfo teConfigInfo;
//     map<string, string> options;
//     EXPECT_EQ(teConfigInfo.Initialize(options), true);
...
TEST(TeConfigInfoUT, init_param_case1) {
  TeConfigInfo teConfigInfo;
  map<string, string> options;
  EXPECT_EQ(teConfigInfo.Initialize(options), true);
...
TEST(TeConfigInfoUT, init_param_case2) {
  TeConfigInfo teConfigInfo;
  map<string, string> options;
  options[ge::OP_COMPILER_CACHE_MODE] = "force";
  options[ge::SOC_VERSION] = "Ascend910B1";
...
TEST(TeConfigInfoUT, init_param_case3) {
  TeConfigInfo teConfigInfo;
  map<string, string> options;
...
TEST(TeConfigInfoUT, init_param_case4) {
  TeConfigInfo teConfigInfo;
  map<string, string> options;
