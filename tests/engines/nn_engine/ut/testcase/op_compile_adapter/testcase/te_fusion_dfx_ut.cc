...
class TeFusionDfxInfoUTest : public testing::Test {
 public:
  TeFusionDfxInfoUTest() {}
...
TEST(TeFusionDfxInfoUTest, manager_init_stest) {
...
TEST(TeFusionDfxInfoUTest, recore_stat_msg) {
  DfxInfoManager dfxInfoManager;
  dfxInfoManager.Initialize();
...
TEST(TeFusionDfxInfoUTest, submit_trace_info) {
