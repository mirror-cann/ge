...
TEST_F(L2FUSION_UT, test_multioutput_add) {
  ...
  PlatformUtils::Instance().pm_item_vec_[static_cast<size_t>(PlatformUtils::PlatformInfoItem::L2Type)] =
      static_cast<int64_t>(L2Type::Buff);
...
void BuildGraphForL2Fusion1(ge::ComputeGraphPtr graph, int32_t reluflag) {
  ...
  elemwise1_node->GetOpDesc()->SetExtAttr(ATTR_NAME_TASK_L2_FUSION_INFO_EXTEND_PTR, elementwise_l2_info_ptr);
}
