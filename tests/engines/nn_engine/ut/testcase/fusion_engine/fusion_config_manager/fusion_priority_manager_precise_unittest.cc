...
TEST_F(UTestFusionPriorityManagerPrecise, TestVectorCoreEngine_242to248) {
...
TEST_F(UTestFusionPriorityManagerPrecise, TestInvalidEngine_245to248) {
...
TEST_F(UTestFusionPriorityManagerPrecise, TestGetGraphFusionPassesAndRulesComplete_310_316_319) {
  FEOpsKernelInfoStorePtr ops_kernel_info_store_ptr = std::make_shared<FEOpsKernelInfoStore>(fe::AI_CORE_NAME);
  std::map<std::string, std::string> options;
  ops_kernel_info_store_ptr->Initialize(options);
  FusionRuleManagerPtr fusion_rule_mgr_ptr = std::make_shared<FusionRuleManager>(ops_kernel_info_store_ptr);
...
TEST_F(UTestFusionPriorityManagerPrecise, TestInitBuiltInPassesVectorCore_278to280) {
  FEOpsKernelInfoStorePtr ops_kernel_info_store_ptr = std::make_shared<FEOpsKernelInfoStore>(fe::VECTOR_CORE_NAME);
  std::map<std::string, std::string> options;
  ops_kernel_info_store_ptr->Initialize(options);
  FusionRuleManagerPtr fusion_rule_mgr_ptr = std::make_shared<FusionRuleManager>(ops_kernel_info_store_ptr);
...
TEST_F(UTestFusionPriorityManagerPrecise, TestSortBufferFusionVectorCore) {
  FEOpsKernelInfoStorePtr ops_kernel_info_store_ptr = std::make_shared<FEOpsKernelInfoStore>(fe::VECTOR_CORE_NAME);
  std::map<std::string, std::string> options;
  ops_kernel_info_store_ptr->Initialize(options);
  FusionRuleManagerPtr fusion_rule_mgr_ptr = std::make_shared<FusionRuleManager>(ops_kernel_info_store_ptr);
...
TEST_F(UTestFusionPriorityManagerPrecise, TestSortGraphFusionComplete) {
  FEOpsKernelInfoStorePtr ops_kernel_info_store_ptr = std::make_shared<FEOpsKernelInfoStore>(fe::AI_CORE_NAME);
  std::map<std::string, std::string> options;
  ops_kernel_info_store_ptr->Initialize(options);
  FusionRuleManagerPtr fusion_rule_mgr_ptr = std::make_shared<FusionRuleManager>(ops_kernel_info_store_ptr);
