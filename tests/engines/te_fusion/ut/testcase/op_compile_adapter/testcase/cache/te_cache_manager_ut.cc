...
class TeCacheManagerUTest : public testing::Test {
 protected:
  static void SetUpTestSuite() {
    ...
    TeCacheManager::Instance().cache_dir_path_ =
    ...
    if (TeCacheManager::Instance().cache_dir_path_.empty()) {
      TeCacheManager::Instance().cache_dir_path_ =
          RealPath("../llt/atc/opcompiler/te_fusion/st/disk_cache/atc_data/kernel_cache");
    }
    if (TeCacheManager::Instance().cache_dir_path_.empty()) {
      TeCacheManager::Instance().cache_dir_path_ =
          RealPath("../../../../../../../../../llt/atc/opcompiler/te_fusion/st/disk_cache/atc_data/kernel_cache");
...
TEST(TeCacheManagerUTest, init_cache_mode_and_dir_02) {
  ...
  EXPECT_EQ(te_cache_manager.Initialize(), true);
  EXPECT_EQ(te_cache_manager.cache_mode_, CompileCacheMode::Disable);
  TeConfigInfo::Instance()
      .config_str_item_vec_[static_cast<size_t>(TeConfigInfo::ConfigStrItem::OpDebugConfig)]
      .clear();
}
...
TEST(TeCacheManagerUTest, pre_compile_cache_01) {
  ...
  PreCompileResultPtr pre_ret1 = TeCacheManager::Instance().MatchPreCompileCache(
      "te_Mul_cd58ce363a48125986d4fd8ef5c8df0e4f0d554e9fc856072d28d6799222c408_pre");
...
bool GetBinFileSha256Value_Stub1(te::fusion::PythonApiCall *This, const char *binData, const size_t binSize,
...
bool GetBinFileSha256Value_Stub2(te::fusion::PythonApiCall *This, const char *binData, const size_t binSize,
                                 std::string &sha256Val) {
...
TEST(TeCacheManagerUTest, compile_cache_02) {
  ...
  std::string json_file_path = GetCodeDir() +
                               "/tests/engines/nn_engine/ut/testcase/op_compile_adapter/disk_cache/kernel_meta/"
...
TEST(TeCacheManagerUTest, compile_cache_autofuse_02) {
  system(
      "g++ -fPIC -DENABLE_T -shared -o "
      "llt/atc/opcompiler/te_fusion/st/disk_cache/kernel_meta/"
      "libte_ascbackend_9865e0fbe56139e85cc42efcf59ac9ab77ee34c3f14e3272f0ea1e2bbedf8abe.so "
      "llt/atc/opcompiler/te_fusion/st/disk_cache/kernel_meta/example.cc");
  CompileResultPtr com_ret4 = CompileResultUtils::ParseCompileResult(
      "./llt/atc/opcompiler/te_fusion/st/disk_cache/kernel_meta/"
      "te_ascbackend_9865e0fbe56139e85cc42efcf59ac9ab77ee34c3f14e3272f0ea1e2bbedf8abe.json");
  system(
      "rm "
      "llt/atc/opcompiler/te_fusion/st/disk_cache/kernel_meta/"
      "libte_ascbackend_9865e0fbe56139e85cc42efcf59ac9ab77ee34c3f14e3272f0ea1e2bbedf8abe.so");
...
TEST(TeCacheManagerUTest, compile_cache_autofuse_static_02) {
  system(
      "g++ -fPIC -DENABLE_T -shared -o "
      "llt/atc/opcompiler/te_fusion/st/disk_cache/kernel_meta/"
      "libte_ascbackend_9865e0fbe56139e85cc42efcf59ac9ab77ee34c3f14e3272f0ea1e2bbedf8abc.so "
      "llt/atc/opcompiler/te_fusion/st/disk_cache/kernel_meta/example.cc");
  CompileResultPtr com_ret4 = CompileResultUtils::ParseCompileResult(
      "./llt/atc/opcompiler/te_fusion/st/disk_cache/kernel_meta/"
      "te_ascbackend_9865e0fbe56139e85cc42efcf59ac9ab77ee34c3f14e3272f0ea1e2bbedf8abc.json");
  system(
      "rm "
      "llt/atc/opcompiler/te_fusion/st/disk_cache/kernel_meta/"
      "libte_ascbackend_9865e0fbe56139e85cc42efcf59ac9ab77ee34c3f14e3272f0ea1e2bbedf8abc.so");
...
bool GetBinFileSha256Value_Stub3(te::fusion::PythonApiCall *This, const char *binData, const size_t binSize,
                                 std::string &sha256Val) {
