...
namespace te {
namespace fusion {
class FusionApiSTest : public testing::Test
{
protected:
    static void SetUpTestCase() {
        std::cout << "FusionApiSTest SetUpTestCase" << std::endl;
    }

    static void TearDownTestCase() {
        std::cout << "FusionApiSTest TearDownTestCase" << std::endl;
    }
};

TEST(FusionApiSTest, init_and_finalize)
{
