...
EsbTensor *EsConditionalAccumulator(EsbGraph *owner_graph, ge::DataType dtype, const int64_t *shape, int64_t shape_num,
...
EsbTensor *EsDequeue(EsbTensor *queue_id, ge::DataType output_type, const int64_t *output_shape,
...
EsbTensor *EsFileConstant(EsbGraph *owner_graph, const int64_t *shape, int64_t shape_num, ge::DataType dtype,
...
EsbTensor *EsHashTable(EsbGraph *owner_graph, ge::DataType key_dtype, ge::DataType value_dtype, const char *container,
...
EsbTensor *EsHcomReceive(EsbGraph *owner_graph, const char *group, int64_t sr_tag, int64_t src_rank,
                         const int64_t *shape, int64_t shape_num, ge::DataType dtype);
...
EsbTensor *EsIndexToAddr(EsbTensor *base_addr, EsbTensor *x, const int64_t *ori_shape, int64_t ori_shape_num,
                         ...
                         const char *block_storage_mode, int64_t rank_id, ge::DataType dtype);
...
EsbTensor *EsInitEmbeddingHashmap(EsbTensor *table_id, int64_t value_total_len, int64_t embedding_dim,
                                  int64_t bucket_size, ge::DataType dtype, const char *initializer_mode,
...
EsbTensor *EsInitEmbeddingHashmapV2(EsbTensor *table_id, int64_t bucket_size, int64_t load_factor,
                                    int64_t embedding_dim, ge::DataType dtype);
...
EsbTensor *EsLruCache(EsbGraph *owner_graph, ge::DataType dtype, const char *container, const char *shared_name,
...
EsbTensor *EsMultinomialWithReplacement(EsbTensor *x, EsbTensor *seed, EsbTensor *offset, int64_t numsamples,
                                        bool replacement);
EsbTensor *EsMutableDenseHashTable(EsbTensor *empty_key, EsbTensor *deleted_key, ge::DataType value_dtype,
...
EsbTensor *EsMutableHashTable(EsbGraph *owner_graph, ge::DataType key_dtype, ge::DataType value_dtype,
                              const char *container, const char *shared_name, bool use_node_name_sharing);
EsbTensor *EsMutableHashTableOfTensors(EsbGraph *owner_graph, ge::DataType key_dtype, ge::DataType value_dtype,
                                       const char *container, const char *shared_name, bool use_node_name_sharing,
...
EsNonMaxSuppressionV5Output EsNonMaxSuppressionV5(EsbTensor *boxes, EsbTensor *scores, EsbTensor *max_output_size,
                                                  EsbTensor *iou_threshold, EsbTensor *score_threshold,
                                                  EsbTensor *soft_nms_sigma, ge::DataType T,
                                                  bool pad_to_max_output_size);
...
EsbTensor *EsResourceConditionalAccumulator(EsbGraph *owner_graph, ge::DataType dtype, const int64_t *shape,
...
EsbTensor *EsSearchSorted(EsbTensor *sorted_sequence, EsbTensor *values, EsbTensor *sorter, ge::DataType dtype,
                          bool right);
...
EsSparseCrossOutput EsSparseCross(EsbTensor **indices, int64_t indices_num, EsbTensor **values, int64_t values_num,
                                  ...
                                  int64_t dense_inputs_num, bool hashed_output, int64_t hash_key, ge::DataType out_type,
                                  ge::DataType internal_type, int64_t N, int64_t num_buckets);
...
EsbTensor *EsStatefulRandomBinomial(EsbTensor *x, EsbTensor *algorithm, EsbTensor *shape, EsbTensor *counts,
                                    EsbTensor *probs, ge::DataType dtype);
...
EsTakeManySparseFromTensorsMapOutput EsTakeManySparseFromTensorsMap(EsbTensor *handles, ge::DataType dtype,
                                                                    const char *container, const char *shared_name);
...
EsTensorArrayOutput EsTensorArray(EsbTensor *size, ge::DataType dtype, const int64_t *element_shape,
...
EsTensorArrayConcatOutput EsTensorArrayConcat(EsbTensor *handle, EsbTensor *flow_in, ge::DataType dtype,
                                              const int64_t *element_shape_except0, int64_t element_shape_except0_num);
EsbTensor *EsTensorArrayGather(EsbTensor *handle, EsbTensor *indices, EsbTensor *flow_in, ge::DataType dtype,
...
EsTensorListConcatV2Output EsTensorListConcatV2(EsbTensor *input_handle, EsbTensor *element_shape,
                                                EsbTensor *leading_dims, ge::DataType element_dtype);
...
EsbTensor *EsTensorListReserve(EsbTensor *element_shape, EsbTensor *num_elements, ge::DataType element_dtype,
                               ge::DataType shape_type);
...
EsbTensor *EsTensorListScatterV2(EsbTensor *tensor, EsbTensor *indices, EsbTensor *element_shape,
                                 EsbTensor *num_elements, ge::DataType element_dtype);
...
EsbTensor *EsTensorListSplit(EsbTensor *tensor, EsbTensor *element_shape, EsbTensor *lengths,
                             ge::DataType element_dtype);
EsbTensor *EsTensorListStack(EsbTensor *input_handle, EsbTensor *element_shape, ge::DataType element_dtype,
...
EsUnicodeDecodeOutput EsUnicodeDecode(EsbTensor *input, const char *input_encoding, const char *errors,
                                      int64_t replacement_char, bool replace_control_characters, ge::DataType Tsplits);
...
EsUnicodeDecodeWithOffsetsOutput EsUnicodeDecodeWithOffsets(EsbTensor *input, const char *input_encoding,
                                                            ...
                                                            bool replace_control_characters, ge::DataType Tsplits);
...
EsUniqueWithCountsExt2Output EsUniqueWithCountsExt2(EsbTensor *x, EsbTensor *axis, ge::DataType out_idx, bool sorted,
                                                    bool return_inverse);
...
EsbTensor *EsUpsampleTrilinear3dGrad(EsbTensor *grad_output, const int64_t *input_size, int64_t input_size_num,
                                     const int64_t *output_size, int64_t output_size_num, const float *scales,
                                     int64_t scales_num, bool align_corners);
EsbTensor *EsVarHandleOp(EsbGraph *owner_graph, ge::DataType dtype, const char *container, const char *shared_name,
