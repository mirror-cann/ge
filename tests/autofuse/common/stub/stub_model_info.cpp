...
ModelInfo CreateCeilingModel() {
  ...
  Expr expr_s2T = ge::sym::Ceiling(expr_s2 / ge::sym::Max(ge::sym::kSymbolOne, expr_s2t));
  ...
  Expr core_num = ge::sym::Ceiling((expr_s1 * ge::sym::Ceiling(expr_s2 / ge::sym::Max(ge::sym::kSymbolOne, expr_s2t))) /
                                   ge::sym::Max(ge::sym::kSymbolOne, expr_s1s2Tb));
