...
void FillL2TileModelInfo(att::ModelInfo &model_info, const L2TileExprContext &ctx)
{
  ...
  att::Expr base_cnt = ge::sym::Max(ge::sym::kSymbolOne,
  ...
  att::Expr al1_mte2 = (((ctx.expr_basem * ctx.expr_stepka * att::CreateExpr(2)) /
                         (att::CreateExpr(32) / ge::sym::Max(ge::sym::kSymbolOne,
...
ModelInfo CreateCeilingModel()
{
  ...
  Expr core_num = ge::sym::Ceiling((expr_s1 * ge::sym::Ceiling(expr_s2 / ge::sym::Max(ge::sym::kSymbolOne,
                          expr_s2t))) / ge::sym::Max(ge::sym::kSymbolOne, expr_s1s2Tb));
