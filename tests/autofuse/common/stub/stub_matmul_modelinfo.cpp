...
MatmulPerfContext CalcMatmulLoopCnts(const MatmulExprContext &ctx) {
  ...
  perf.base_cnt = ge::sym::Max(ge::sym::kSymbolOne, (((ctx.expr_tilem / GetSafeDivisor(ctx.expr_basem)) *
...
void FillMatmulPerfObjects(att::ModelInfo &model_info, const MatmulExprContext &ctx, const MatmulPerfContext &perf) {
  ...
  att::Expr l0_mac = ge::sym::Ceiling(ctx.expr_basem / att::CreateExpr(16)) *
                     ge::sym::Ceiling(ctx.expr_basek / att::CreateExpr(16)) *
                     ge::sym::Ceiling(ctx.expr_basen / att::CreateExpr(16));
  att::Expr mac = (perf.tile_cnt * perf.base_cnt * l1_cnt * perf.l0_cnt) * l0_mac;
  std::cout << "mac: " << mac << std::endl;

  att::Expr al1_mte2 =
      (((ctx.expr_basem * ctx.expr_stepka) * att::CreateExpr(2)) /
       (att::CreateExpr(32) / ge::sym::Max(ge::sym::kSymbolOne, (att::CreateExpr(256) / ctx.expr_stepka)))) +
      att::CreateExpr(210);
  att::Expr bl1_mte2 =
      (((ctx.expr_stepkb * ctx.expr_basen) * att::CreateExpr(2)) /
       (att::CreateExpr(32) / ge::sym::Max(ge::sym::kSymbolOne, (att::CreateExpr(256) / ctx.expr_basen)))) +
      att::CreateExpr(210);
