...
inline ge::Status GenTilingImpl(std::vector<ascir::ScheduledResult> &schedule_results) {
  ...
  (void)std::system(std::string("cp ")
                        .append(TOP_DIR)
                        .append("/tests/autofuse/st/att/testcase/stub/platform_ascendc.h ./tiling/ -f")
                        .c_str());
  (void)std::system(std::string("cp ")
                        .append(TOP_DIR)
                        .append("/tests/autofuse/st/att/testcase/stub/tiling_api.h ./tiling/ -f")
                        .c_str());
  (void)std::system(std::string("cp ")
                        .append(TOP_DIR)
                        .append("/tests/autofuse/st/att/testcase/stub/tiling_context.h ./tiling/ -f")
                        .c_str());
  (void)std::system(std::string("cp ")
                        .append(TOP_DIR)
                        .append("/tests/autofuse/st/att/testcase/stub/tilingdata_base.h ./register/ -f")
                        .c_str());
  return ge::SUCCESS;
}
