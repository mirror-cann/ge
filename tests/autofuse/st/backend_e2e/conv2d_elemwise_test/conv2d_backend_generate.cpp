...
static void CreateElemwiseGraphWithAbs(ge::AscGraph &graph) {
...
static void CreateElemwiseGraphWithMul(ge::AscGraph &graph) {
  auto s0 = graph.CreateSizeVar(64);
  auto s1 = graph.CreateSizeVar(64);
  auto z0 = graph.CreateAxis("z0", s0);
  auto z1 = graph.CreateAxis("z1", s1);
...
static bool OptimizeAndGenerateCode(codegen::TilingLib &tiling_lib, ge::AscGraph &graph,
                                     ge::AscGraph &conv2d_graph, const std::string &tiling_func_file) {
  try {
...
static void CreateElemwiseGraphWithMulScalar(ge::AscGraph &graph, const std::string &scalar_value) {
  auto s0 = graph.CreateSizeVar(64);
  auto s1 = graph.CreateSizeVar(64);
  auto z0 = graph.CreateAxis("z0", s0);
  auto z1 = graph.CreateAxis("z1", s1);
  ...
  *scalar.y.repeats = {ge::ops::One, ge::ops::One};
  *scalar.y.strides = {ge::ops::Zero, ge::ops::Zero};
  mul.x2 = scalar.y;
  mul.attr.sched.axis = {z0.id, z1.id};
  mul.y.dtype = ge::DT_FLOAT16;
  *mul.y.axis = {z0.id, z1.id};
...
static void CreateElemwiseGraphWithAddScalar(ge::AscGraph &graph, const std::string &scalar_value) {
  auto s0 = graph.CreateSizeVar(64);
  auto s1 = graph.CreateSizeVar(64);
  auto z0 = graph.CreateAxis("z0", s0);
  auto z1 = graph.CreateAxis("z1", s1);
...
void CreateConv2DGraph(ge::AscGraph &graph) {
  ...
  *conv2d.y.strides = {s1, ge::ops::One};
...
void CreateConv2DBiasGraph(ge::AscGraph &graph) {
  auto s0 = graph.CreateSizeVar(32);
  auto s1 = graph.CreateSizeVar(32);
  auto z0 = graph.CreateAxis("z0", s0);
  auto z1 = graph.CreateAxis("z1", s1);
  ...
  *conv2d_bias.y.strides = {s1, ge::ops::One};
...
void CreateConv2DOffsetGraph(ge::AscGraph &graph) {
  auto s0 = graph.CreateSizeVar(32);
  auto s1 = graph.CreateSizeVar(32);
  auto z0 = graph.CreateAxis("z0", s0);
  auto z1 = graph.CreateAxis("z1", s1);
  ...
  *conv2d_offset.y.strides = {s1, ge::ops::One};
...
void CreateConv2DOffsetBiasGraph(ge::AscGraph &graph) {
  auto s0 = graph.CreateSizeVar(32);
  auto s1 = graph.CreateSizeVar(32);
  auto z0 = graph.CreateAxis("z0", s0);
  auto z1 = graph.CreateAxis("z1", s1);
  ...
  *conv2d_offset_bias.y.strides = {s1, ge::ops::One};
