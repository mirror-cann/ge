...
extern "C" int64_t GenerateTopnSolutions(int64_t s0, int64_t s1, int64_t s2,
...
TEST_F(E2EBackendInductorTopnCode, GenerateTopnSolutionsReturnsDefaultTop1) {
  ...
  EXPECT_EQ(GenerateTopnSolutions(32, 16, 16, input_configs, topn, tiling_datas, workspaces, block_dims, &res_limit), 0);
