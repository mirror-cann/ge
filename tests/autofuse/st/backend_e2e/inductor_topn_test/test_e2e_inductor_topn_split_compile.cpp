...
std::string GenerateTopnAndRepr(GenerateTopnSolutionsFn gen_fn, GetTilingDataReprFn repr_fn) {
  ...
  EXPECT_EQ(gen_fn(32, 16, 16, input_configs, 4, tiling_datas, workspaces, block_dims, &res_limit), 0);
