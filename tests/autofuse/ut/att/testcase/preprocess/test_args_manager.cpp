...
TEST_F(ArgsManagerUtest, test_replace_vars) {
  ...
  EXPECT_TRUE(replacements[CreateExpr("basem_size")] ==
              (CreateExpr(16) * ge::sym::Pow(CreateExpr(2), CreateExpr("basem_size_base"))));
  EXPECT_TRUE(replacements.find(CreateExpr("stepm_size")) != replacements.end());
  EXPECT_TRUE(
      replacements[CreateExpr("stepm_size")] ==
      ((ge::sym::Max((CreateExpr(16) * ge::sym::Pow(CreateExpr(2), CreateExpr("basem_size_base"))), CreateExpr(16)) *
...
TEST_F(ArgsManagerUtest, test_update_vars) {
  ...
  replacements.emplace(
      CreateExpr("stepm"),
      (ge::sym::Max((CreateExpr(16) * ge::sym::Pow(CreateExpr(2), CreateExpr("basem_base"))), CreateExpr(16)) *
       CreateExpr("stepm_align")));
  new_expr_replacements.emplace(CreateExpr("basem_base"),
                                ge::sym::Log(CreateExpr(2), (CreateExpr("basem") / CreateExpr(16))));
