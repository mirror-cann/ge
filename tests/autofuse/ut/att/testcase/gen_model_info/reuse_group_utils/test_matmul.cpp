...
TEST_F(TestGenMatmulModelInfoE2E, case1) {
  ...
  ret = std::system(std::string("cp ").append(TOP_DIR).append("/tests/autofuse/st/att/testcase/scenario/tiling_data/tiling_func_matmul_main.cpp ./ -f").c_str());
  ret = std::system(std::string("cp ").append(TOP_DIR).append("/tests/autofuse/st/att/testcase/stub/op_log.h ./ -f").c_str());
