...
REG_OP(LowerBound)
    .INPUT(sorted_x,
           TensorType({DT_FLOAT, DT_FLOAT16, DT_INT8, DT_INT16, DT_UINT16, DT_UINT8, DT_INT32, DT_INT64, DT_DOUBLE}))
    .INPUT(values,
           TensorType({DT_FLOAT, DT_FLOAT16, DT_INT8, DT_INT16, DT_UINT16, DT_UINT8, DT_INT32, DT_INT64, DT_DOUBLE}))
    ...
    */
    ...
    .INPUT(x, TensorType({DT_FLOAT, DT_FLOAT16, DT_INT8, DT_INT16, DT_UINT16, DT_UINT8, DT_INT32, DT_INT64, DT_BOOL,
                          DT_DOUBLE, DT_COMPLEX64, DT_COMPLEX128}))
    .INPUT(seq_lengths, TensorType({DT_INT32, DT_INT64}))
    .OUTPUT(y, TensorType({DT_FLOAT, DT_FLOAT16, DT_INT8, DT_INT16, DT_UINT16, DT_UINT8, DT_INT32, DT_INT64, DT_BOOL,
                           DT_DOUBLE, DT_COMPLEX64, DT_COMPLEX128}))
    ...
    */
    ...
    .INPUT(x, TensorType({DT_FLOAT,      DT_DOUBLE,  DT_INT32,  DT_UINT8,  DT_INT16,  DT_INT8,    DT_COMPLEX64,
                          DT_INT64,      DT_QINT8,   DT_QUINT8, DT_QINT32, DT_QINT16, DT_QUINT16, DT_UINT16,
                          DT_COMPLEX128, DT_FLOAT16, DT_UINT32, DT_UINT64, DT_BOOL,   DT_BF16}))
    .INPUT(axis, TensorType({DT_INT32, DT_INT64}))
    .OUTPUT(y, TensorType({DT_FLOAT,      DT_DOUBLE,  DT_INT32,  DT_UINT8,  DT_INT16,  DT_INT8,    DT_COMPLEX64,
                           DT_INT64,      DT_QINT8,   DT_QUINT8, DT_QINT32, DT_QINT16, DT_QUINT16, DT_UINT16,
                           DT_COMPLEX128, DT_FLOAT16, DT_UINT32, DT_UINT64, DT_BOOL,   DT_BF16}))
    .OUTPUT(idx, TensorType({DT_INT32, DT_INT64}))
    .OUTPUT(count, TensorType({DT_INT32, DT_INT64}))
    ...
    */
    ...
    REG_OP(MirrorPad)
    .INPUT(x, TensorType({DT_INT8, DT_UINT8, DT_INT16, DT_UINT16, DT_INT32, DT_INT64, DT_BF16, DT_FLOAT16, DT_FLOAT,
                          DT_DOUBLE, DT_BOOL, DT_COMPLEX64, DT_COMPLEX128}))
    .INPUT(paddings, TensorType({DT_INT32, DT_INT64}))
    .OUTPUT(y, TensorType({DT_INT8, DT_UINT8, DT_INT16, DT_UINT16, DT_INT32, DT_INT64, DT_BF16, DT_FLOAT16, DT_FLOAT,
                           DT_DOUBLE, DT_BOOL, DT_COMPLEX64, DT_COMPLEX128}))
    ...
    */
    ...
    .OUTPUT(out,
            TensorType({DT_FLOAT, DT_FLOAT16, DT_DOUBLE, DT_UINT8, DT_INT8, DT_INT16, DT_UINT16, DT_INT32, DT_INT64}))
    .OUTPUT(idx, TensorType({DT_INT32, DT_INT64}))
    .ATTR(out_idx, Type, DT_INT32)
    ...
    */
    ...
    /**
    *@brief Creates a file constant tensor, The operator is used to process the very large weight which is store in
    file. \n
    ...
    */
    ...
    /**
    *@brief Returns an integer representing the rank of input tensor. The rank of a tensor is the number of indices
    required to uniquely select each element of the tensor, that is, the dimension size of the tensor. \n
    ...
    */
    REG_OP(Copy)
    .INPUT(x, TensorType({DT_FLOAT, DT_FLOAT16, DT_INT8, DT_UINT8, DT_INT16, DT_UINT16, DT_INT32, DT_UINT32, DT_INT64,
                          DT_UINT64}))
    .DYNAMIC_OUTPUT(y, TensorType({DT_FLOAT, DT_FLOAT16, DT_INT8, DT_UINT8, DT_INT16, DT_UINT16, DT_INT32, DT_UINT32,
                                   DT_INT64, DT_UINT64}))
    .REQUIRED_ATTR(N, Int)
...
REG_OP(ViewCopy)
    ...
    */
    ...
    REG_OP(Fingerprint)
    .INPUT(data, TensorType({DT_DOUBLE, DT_FLOAT, DT_FLOAT16, DT_INT8, DT_UINT8, DT_INT16, DT_UINT16, DT_INT32,
...
REG_OP(EditDistance)
    ...
    */
    ...
    .INPUT(x, TensorType({DT_DOUBLE, DT_FLOAT, DT_FLOAT16, DT_INT8, DT_UINT8, DT_INT16, DT_UINT16, DT_INT32, DT_UINT32,
                          DT_INT64, DT_UINT64, DT_BOOL, DT_BF16}))
    ...
    */
    ...
    .OUTPUT(out_value, TensorType({DT_DOUBLE, DT_FLOAT, DT_FLOAT16, DT_INT8, DT_UINT8, DT_INT16, DT_UINT16, DT_INT32,
                                   DT_UINT32, DT_INT64, DT_UINT64, DT_BOOL}))
    ...
    */
     ...
     */
    REG_OP(EnsureShape)
    .INPUT(input, TensorType({DT_INT8, DT_UINT8, DT_INT16, DT_UINT16, DT_INT32, DT_INT64, DT_FLOAT16, DT_FLOAT,
                              DT_DOUBLE, DT_COMPLEX64, DT_COMPLEX128}))
    .OUTPUT(output, TensorType({DT_INT8, DT_UINT8, DT_INT16, DT_UINT16, DT_INT32, DT_INT64, DT_FLOAT16, DT_FLOAT,
                                DT_DOUBLE, DT_COMPLEX64, DT_COMPLEX128}))
    .REQUIRED_ATTR(shape, ListInt)
    ...
    * @par Attributes:
    * @li return_idx: An optional bool. Whether to also return the indices. The default value is False. Currently only
    False is supported.
    * @li return_count: An optional bool. Whether to also return the counts for each element. The default is False.
    * @li axis: An optional int. Which one axis to apply unique. The default is 1000, which means None. Currently only
    1000 is supported.
