...
REG_OP(AddN)
    ...
    */
    REG_OP(Equal)
    .INPUT(x1, TensorType({DT_FLOAT, DT_BF16, DT_FLOAT16, DT_INT32, DT_INT8, DT_UINT8, DT_DOUBLE, DT_INT16, DT_INT64,
                           DT_COMPLEX64, DT_COMPLEX128, DT_QUINT8, DT_QINT8, DT_QINT32, DT_STRING, DT_BOOL}))
    .INPUT(x2, TensorType({DT_FLOAT, DT_BF16, DT_FLOAT16, DT_INT32, DT_INT8, DT_UINT8, DT_DOUBLE, DT_INT16, DT_INT64,
                           DT_COMPLEX64, DT_COMPLEX128, DT_QUINT8, DT_QINT8, DT_QINT32, DT_STRING, DT_BOOL}))
    .OUTPUT(y, TensorType({DT_BOOL}))
    ...
    * @par Attributes:
    * @li base: An optional attribute of type float32, specifying the base gamma. Must be positive or "-1.0", defaults
    to "-1.0".
    ...
    */
    REG_OP(Xlog1py)
    .INPUT(x, TensorType({DT_BF16, DT_FLOAT16, DT_FLOAT, DT_DOUBLE, DT_COMPLEX64, DT_COMPLEX128}))
    .INPUT(y, TensorType({DT_BF16, DT_FLOAT16, DT_FLOAT, DT_DOUBLE, DT_COMPLEX64, DT_COMPLEX128}))
    .OUTPUT(z, TensorType({DT_BF16, DT_FLOAT16, DT_FLOAT, DT_DOUBLE, DT_COMPLEX64, DT_COMPLEX128}))
    ...
    *
    *@par Inputs:
    * x: A tensor. Must be one of the following types: float16, bfloat16, float32, float64, int32, int64, complex64,
    complex128.
    *
    *@par Outputs:
    ...
    */
    REG_OP(Asin)
    .INPUT(x, TensorType({DT_FLOAT16, DT_FLOAT, DT_BF16, DT_DOUBLE, DT_INT32, DT_INT64, DT_COMPLEX64, DT_COMPLEX128}))
    .OUTPUT(y, TensorType({DT_FLOAT16, DT_FLOAT, DT_BF16, DT_DOUBLE, DT_INT32, DT_INT64, DT_COMPLEX64, DT_COMPLEX128}))
    ...
    * @li value: An ND or 5HD tensor. Support 1D~8D. Must be one of the following types: bfloat16, float16, float32,
    ...
    *@li validate_shape: An optional bool. Defaults to "true".
                         If "true", the operation will validate that the shape of "value" matches the shape of the
    Tensor being assigned to.
    ...
    *
    * @par Inputs:
    * @li var: An ND or 5HD tensor. Support 1D~8D. Must be one of the following types: bfloat16, float32, float64,
    int32, uint8 \n
    ...
    */
     ...
     */
    REG_OP(OnesLike)
    .INPUT(x, TensorType({DT_FLOAT16, DT_FLOAT, DT_DOUBLE, DT_INT8, DT_UINT8, DT_INT16, DI_UINT16, DT_INT32, DT_INT64,
                          DT_COMPLEX128, DT_BOOL, DT_BF16}))
    .OUTPUT(y, TensorType({DT_FLOAT16, DT_FLOAT, DT_DOUBLE, DT_INT8, DT_UINT8, DT_INT16, DI_UINT16, DT_INT32, DT_INT64,
                           DT_COMPLEX128, DT_BOOL, DT_BF16}))
    ...
    */
    ...
    /**
    * @brief Computes arctangent of x1/x2 element-wise, respecting signs of the arguments. Support broadcasting
    operations.
    ...
    *
    *@par Inputs:
    *@li x1: A tensor. Must be one of the following types: float32, float64, int32, uint8, int16, int8, complex64,
    int64, qint8, quint8, qint32, uint16, complex128, float16, uint32, uint64
    *@li x2: A tensor of the same dtype as "x1".
    *
    *@par Attributes:
    ...
    *@par Inputs:
    *Two inputs, including:
    *@li gradients: A ND Tensor of type float32. Shape support 1D ~ 8D. Backpropagated gradients above the
    FakeQuantWithMinMaxArgs operation.
    *@li x: A ND Tensor of type float32. Shape support 1D ~ 8D. Shape should be equal to the shape of "gradients". Has
    the same dtype and format as "gradients".
    ...
    *@li "gradients" has the same shape as "x".
    *@li "min" and "max" have one-dimensional shapes.
    *@li "min" has the same last dimension size as "x". "max" has the same last dimension size as "x". "gradients" has
    the same last dimension size as "x".
    *@li "num_bits" is between 2 and 16.
    ...
    */
    REG_OP(Round)
    .INPUT(x, TensorType(DT_FLOAT16, DT_BF16, DT_FLOAT, DT_INT32, DT_INT64, DT_DOUBLE))
    .OUTPUT(y, TensorType(DT_FLOAT16, DT_BF16, DT_FLOAT, DT_INT32, DT_INT64, DT_DOUBLE))
    .ATTR(decimals, Int, 0)
    ...
    */
    REG_OP(Tan)
    .INPUT(x, TensorType({DT_FLOAT, DT_BF16, DT_FLOAT16, DT_DOUBLE, DT_COMPLEX64, DT_COMPLEX128, DT_INT32, DT_INT64}))
    .OUTPUT(y, TensorType({DT_FLOAT, DT_BF16, DT_FLOAT16, DT_DOUBLE, DT_COMPLEX64, DT_COMPLEX128, DT_INT32, DT_INT64}))
    ...
    *@par Inputs:
    *Two inputs, including:
    *@li x: A ND Tensor. Must be one of the following types: float32, float64, int32, uint8, int16, int8, complex64,
    int64, qint8, quint8, qint32, bfloat16, uint16, complex128, float16, uint32, uint64. *format is ND.
    *@li dimension: A 1D ND tensor or scalar, data type is int32 or int64 and value range is [-rank(input x), rank(input
    x)].
    ...
    *@par Outputs:
    *y: A ND tensor of type int32 or int64, specifying the index with the largest value. The dimension is one less than
    that of "x".
    ...
    *@par Outputs:
    *y: A multi-dimensional Tensor of type int32, specifying the index with the largest value. The dimension is one less
    than that of "x". \n
    ...
    *@li input1: A ND Tensor specifying second moment. Values must be greater than or equal to 0. Support float16,
    float32, bfloat16.
    *@li input2: A ND Tensor specifying first moment. Support float16, float32, bfloat16.
    *@li input3: A ND Tensor specifying parameters to be updated. Support float16, float32, bfloat16.
    ...
    * @li input2: A ND tensor specifying first moment. Support float16, float32, bfloat16.
    * @li input3: A ND tensor specifying parameters to be updated. Support float16, float32, bfloat16.
    * @li input4: A ND tensor specifying the learning rate. Values must be greater than 0. Shape size must be equal
    to 1. Support float16, float32, bfloat16.
    * @li mul0_x: A ND tensor specifying beta1. Values must be greater than 0. Shape size must be equal to 1. Support
    float16, float32, bfloat16.
    * @li mul1_x: A ND tensor specifying 1 - beta1. Values must range from 0 to 1. Shape size must be equal to 1.
    ...
    * @li mul2_x: A ND tensor specifying beta2. Values must be greater than 0. Shape size must be equal to 1. Support
    float16, float32, bfloat16.
    * @li mul3_x: A ND tensor specifying 1 - beta2. Values must range from 0 to 1. Shape size must be equal to 1.
    Support float16, float32, bfloat16.
    * @li mul4_x: A ND tensor specifying weight. Values must be greater than or equal to 0. Support float16, float32,
    bfloat16.
    * @li add2_y: A ND tensor ued for improving numerical stability. Values must be greater than 0. Support float16,
    ...
    *@par Outputs:
    * y: A ND Tensor with any format. Has the same dtype as the input. Must be one of the following types: float16,
    float32, bfloat16.
    *@par Third-party framework compatibility
...
*@par Attributes:
*@li axis: An optional int. Specify the axis to be cut at the input tensor. If this parameter is not provided, find the
topk for each batch. Defaults to 10000
*@li out_max_val: An optional bool. Whether to output the maximum value. If it is True, the maximum value and index are
output, otherwise only the index is output.
* Defaults to False
*@li topk: An optional int. It means the number of top tok in each axis (the value is greater than or equal to 1), and
the value range must be in [1,x.shape(axis)].
* Defaults to 1
...
REG_OP(ArgMaxWithK)
    ...
    * @par Inputs:
    * Two inputs, including:
    * @li x: Tensor with one of the following types: float16, float32, double, bfloat16. Support 1D ~ 8D. Support
    format:
    ...
    * y: A ND Tensor of the same dtype as x, output shape=[1,], when reduction='sum' or 'batchmean'.
         when reduction='none', output y is a tensor, Support 1D ~ 8D. Must have the same type, shape and format as
    input "x".
    * @par Third-party framework compatibility
    ...
    */
    ...
    .OUTPUT(y, "T4")
    .DATATYPE(T1, TensorType({DT_FLOAT, DT_FLOAT16, DT_DOUBLE, DT_UINT8, DT_INT8, DT_UINT16, DT_INT16, DT_INT32,
                              DT_INT64, DT_COMPLEX64, DT_COMPLEX128, DT_BF16, DT_COMPLEX32}))
    .DATATYPE(T2, TensorType({DT_FLOAT, DT_FLOAT16, DT_DOUBLE, DT_UINT8, DT_INT8, DT_UINT16, DT_INT16, DT_INT32,
                              DT_INT64, DT_COMPLEX64, DT_COMPLEX128, DT_BF16, DT_COMPLEX32}))
    .DATATYPE(T3, TensorType({DT_FLOAT, DT_FLOAT16, DT_DOUBLE, DT_UINT8, DT_INT8, DT_UINT16, DT_INT16, DT_INT32,
                              DT_INT64, DT_COMPLEX64, DT_COMPLEX128, DT_BF16, DT_COMPLEX32}))
    .DATATYPE(T4, Promote({"T1", "T2", "T3"}))
    ...
    * @par Outputs:
    * output_z: A ND tensor. Bool type, compare result of the two inputs. True if element in input_x is equal to
    input_y, False otherwise. \n
    ...
    */
    ...
    .INPUT(input_x, TensorType({DT_FLOAT16, DT_FLOAT, DT_DOUBLE, DT_INT64, DT_INT32, DT_INT8, DT_UINT8, DT_BOOL,
                                DT_BF16, DT_IN16, DT_UINT16, DT_UINT32, DT_UINT64}))
