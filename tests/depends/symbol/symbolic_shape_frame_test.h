...
class ExpectNodeInfoCheckBase {
 public:
  ExpectNodeInfoCheckBase(std::string node_name, std::vector<Expression> expect_symbol_output_shape,
                          std::set<std::string> expect_guard_infos, std::set<std::string> expect_assert_infos,
                          std::vector<Expression> expect_symbolic_value, size_t output_idx)
