...
aclError Om2ArgsTable::Init() {
  ...
  iow_args_addrs_ = {{GetHostArgAddr(0), GetHostArgAddr(8), GetHostArgAddr(16)}, {GetHostArgAddr(0), GetHostArgAddr(8), GetHostArgAddr(16)}, {GetHostArgAddr(0), GetHostArgAddr(8), GetHostArgAddr(16)}};
  return ACL_SUCCESS;
}
