...
TEST_F(NodeExecutorTest, TestGetOrCreateExecutor) {
  ...
  manager.builders_[NodeExecutorManager::ExecutorType::AICORE] = []() -> std::unique_ptr<::ge::hybrid::NodeExecutor> {
    return MakeUnique<FailureNodeExecutor>();
  };
  manager.builders_[NodeExecutorManager::ExecutorType::AICPU_TF] = []() -> std::unique_ptr<::ge::hybrid::NodeExecutor> {
