...
Result SampleRes50ImagenetClassification::Process(uint64_t batchSize) {
  std::vector<std::string> testFiles = {"../data/dog1_1024_683.bin", "../data/dog2_1024_683.bin"};
  ...
  aclError aclRet =
      aclmdlGetInputIndexByName(modelDesc_->GetModelDesc(), ACL_DYNAMIC_TENSOR_NAME, &dynamic_input_index);
