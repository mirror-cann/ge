...
|   └── make_transformer_nz_graph.cpp  // Sample file
├── CMakeLists.txt                  // CMake build file
...
Besides basic graph building and dump functionality, esb_sample also supports building graph and actually executing computation.
