...
def get_args():
    ...
    parser.add_argument("-raw", required=False, dest="raw", help="INPUT: recovered raw img")
    parser.add_argument("--rcvr", help="recover the raw img without header", action="store_true")
